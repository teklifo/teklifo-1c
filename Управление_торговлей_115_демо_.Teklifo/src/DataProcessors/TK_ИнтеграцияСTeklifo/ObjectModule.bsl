...
Функция ПолучитьУчетнуюЗапись() Экспорт
	...
	УчетнаяЗапись = Справочники.TK_УчетныеЗаписиTeklfio.СоздатьЭлемент();
...
Функция ПолучитьРезультатСозданияОрганизацииНаСайте(СтруктураПараметров, ТокенСессии = "") Экспорт
	...
	ТелоЗапроса = TK_РаботаСWebВызовСервера.СериализоватьJSON(СтруктураПараметров);
...
// 
// Параметры:
//  УчетнаяЗапись - СправочникСсылка.TK_УчетныеЗаписиTeklfio - Учетная запись
// 
// Возвращаемое значение:
