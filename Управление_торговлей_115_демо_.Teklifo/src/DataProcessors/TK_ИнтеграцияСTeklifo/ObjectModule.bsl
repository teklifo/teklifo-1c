...
Процедура ПолучитьCSRFТокен() Экспорт
	...
	ДанныеОтвета = TK_РаботаСWebВызовСервера.ПолучитьДанныеИзJSON(ТелоJSON);
...
Функция СоздатьОрганизациюНаTeklifo(ДанныеОрганизации) Экспорт
	...
	ПараметрыHTTPЗапроса.ТелоЗапроса = TK_РаботаСWebВызовСервера.СериализоватьJSON(ДанныеОрганизации);
	...
	Возврат TK_РаботаСWebВызовСервера.ПолучитьДанныеИзJSON(ТелоJSON);
...
Функция ПолучитьРезультатОтправкиНоменклатуры(МассивНоменклатуры, ТокенСессии = "", ОрганизацияНаСайте = "") Экспорт
	...
	ТелоЗапроса = TK_РаботаСWebВызовСервера.СериализоватьJSON(МассивДанных);
	...
	СтруктураДанных = TK_РаботаСWebВызовСервера.ПолучитьДанныеИзJSON(Ответ);
...
Функция ПолучитьРезультатОтправкиДокументаЗапросЦенПоставщикам(ДанныеОтправки, ТокенСессии = "",
	...
	ТелоЗапроса = TK_РаботаСWebВызовСервера.СериализоватьJSON(ДанныеОтправки);
