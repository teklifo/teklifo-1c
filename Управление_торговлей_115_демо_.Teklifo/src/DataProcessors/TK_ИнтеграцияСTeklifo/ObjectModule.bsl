...
Функция ДанныеЗапросаЦенПоставщикам(ЗапросЦенПоставщикам)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
						  ...
						  |	СоответствиеНоменклатуры.ВнешнийИдентификатор КАК ВнешнийИдентификаторНоменклатуры,
...
Функция ДанныеКПубликацииКоммерческогоПредложенияКлиенту(КоммерческоеПредложениеКлиенту)
	...
	Если ВыборкаДокумент.Следующий() Тогда
		...
		Пока ВыборкаДетали.Следующий() Цикл
			...
			ПозицияЗапросаПоставщикам.vatRate = СтавкаНДСTeklifo(ВыборкаДетали.СтавкаНДС);
...
Функция СтавкаНДСTeklifo(СтавкаНДС)
