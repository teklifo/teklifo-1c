...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВнешняяСсылка = TK_ОбщегоНазначенияВызовСервера.ВнешняяСсылкаНаОпубликованноеКоммерческоеПредложениеКлиенту(Документ);
...
Процедура СкопироватьСсылкуВБуфер(Команда)
	...
	ТекстСообщения = НСтр("ru = 'Внешняя ссылка на коммерческое предложение скопирована в буфер обмена.'");
