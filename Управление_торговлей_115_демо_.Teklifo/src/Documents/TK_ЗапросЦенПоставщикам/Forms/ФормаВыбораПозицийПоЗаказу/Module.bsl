...
Функция ЗаполнитьДокументНаСервере(ДанныеФормы,АдресДокументаЗаказа)
...
Функция ДокументЗаказа(Выборка)
	КП = Выборка.КоммерческоеПредложение;
	
	СтруктураРеквизитов = ОбщегоНазначенияУТВызовСервера.ЗначенияРеквизитовОбъекта(КП, "Организация,Контрагент");
