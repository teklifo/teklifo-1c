...
Функция ЗагрузитьДокументЗапросЦенОтКлиента(ДанныеЗагрузки, Организация) Экспорт
	...
	НомерЗапросаЦен = ДанныеЗагрузки.number; // Строка
	ЭтоАктуальнаяВерсия = ДанныеЗагрузки.latestVersion; // Булево
	ИдентификаторВерсииЗапросаЦен = ДанныеЗагрузки.versionId; // Строка
	...
	СтруктураОтвета.Вставить("number", НомерЗапросаЦен);
	СтруктураОтвета.Вставить("latestVersion", ЭтоАктуальнаяВерсия);
	СтруктураОтвета.Вставить("versionId", ИдентификаторВерсииЗапросаЦен);
