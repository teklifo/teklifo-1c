...
Процедура УстановитьСтатусПубликацииЗаказаЦенПоставщикам(ЗапросЦенПоставщикам, СтатусПубликации) Экспорт
...
// Возвращает данные опубликованного коммерческого предложения клиенту.
// 
// Параметры:
...
// * Идентификатор - Строка
// * НомерДокумента - Строка
Функция ДанныеОпубликованногоКоммерческогоПредложенияКлиенту(КоммерческоеПредложениеКлиенту) Экспорт
...
Функция ВнешняяСсылкаНаОпубликованноеКоммерческоеПредложениеКлиенту(КоммерческоеПредложениеКлиенту) Экспорт
	...
	ДанныеПубликации = ДанныеОпубликованногоКоммерческогоПредложенияКлиенту(КоммерческоеПредложениеКлиенту);

	ВнешняяСсылка = "";

	Если ЗначениеЗаполнено(ДанныеПубликации.Идентификатор) Тогда
		ВнешняяСсылка = СтрШаблон("https://teklifo.com/quotation/%1", ДанныеПубликации.Идентификатор);
	КонецЕсли;
