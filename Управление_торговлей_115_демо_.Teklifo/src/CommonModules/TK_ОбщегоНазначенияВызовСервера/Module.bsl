...
// Получить телефон и email организации.
// 
// Параметры:
//  Организация - СправочникСсылка.Организации - Организация
// 
// Возвращаемое значение:
//  Структура - Получить телефон и email организации:
// * НомерТелефона - Строка - 
// * Email - Строка - 
Функция ПолучитьТелефонИEmailОрганизации(Организация) Экспорт
	...
	Возврат Новый Структура("НомерТелефона,Email",НомерТелефона,Email);
