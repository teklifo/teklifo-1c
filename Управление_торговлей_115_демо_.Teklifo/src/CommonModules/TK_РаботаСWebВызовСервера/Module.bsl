...
Функция ПолучитьТокенСессии(УчетнаяЗапись)
	...
	ТокенСессии = ОбработкаИнтеграции.АвторизоватьПользователяНаСервере(СтруктураТокенов);
...
Функция ПолучитьДанныеПоОрганизации(Организация)
	...
	Структура = Новый Структура("УчетнаяЗапись,ИдентификаторОрганизацииTeklifo,Организация", Выборка.УчетнаяЗапись,
		Выборка.ИдентификаторОрганизацииTeklifo, Выборка.Организация);
